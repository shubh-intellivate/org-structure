    ...
    (t.prototype = {
        init: function (e) {
            ...
            return (
                ...
                "object" === v.type(i)
                    ? i instanceof v
                        ? this.buildHierarchy(s, this.buildJsonDS(i.children()), 0, this.options)
                        : this.buildHierarchy(s, this.options.ajaxURL ? i : this.attachRel(i, "00"))
                    : (s.append('<i class="fa fa-circle-o-notch fa-spin spinner"></i>'),
                      v
                          .ajax({ url: i, dataType: "json" })
                          .done(function (e, t, i) {
                ...
                t.append(s),
                this.options.exportButton && !t.find(".oc-export-btn").length && this.attachExportButton(),
        ...
        setOptions: function (e, t) {
            return (
                "string" == typeof e && ("pan" === e && (t ? this.bindPan() : this.unbindPan()), "zoom" === e && (t ? this.bindZoom() : this.unbindZoom())),
                "object" == typeof e && (e.data ? this.init(e) : (void 0 !== e.pan && (e.pan ? this.bindPan() : this.unbindPan()), void 0 !== e.zoom && (e.zoom ? this.bindZoom() : this.unbindZoom()))),
                this
            );
        },
        panStartHandler: function (e) {
            ...
            if (v(e.target).closest(".node").length || (e.touches && 1 < e.touches.length)) a.data("panning", !1);
                ...
                if ("none" !== n) {
                    var s = n.split(",");
                    -1 === n.indexOf("3d") ? ((t = parseInt(s[4])), (i = parseInt(s[5]))) : ((t = parseInt(s[12])), (i = parseInt(s[13])));
                }
                var o = 0,
                    d = 0;
                if (e.targetTouches) {
        ...
        bindPan: function () {
            this.$chartContainer.css("overflow", "hidden"), this.$chart.on("mousedown touchstart", this.panStartHandler), v(f).on("mouseup touchend", { chart: this.$chart }, this.panEndHandler);
        },
        unbindPan: function () {
        ...
        zoomWheelHandler: function (e) {
            var t = e.data.oc;
            e.preventDefault();
            var i = 1 + (0 < e.originalEvent.deltaY ? -0.2 : 0.2);
        ...
        zoomEndHandler: function (e) {
            ...
            if (t.$chart.data("pinching")) {
                ...
                0 < i ? t.setChartScale(t.$chart, 1.2) : i < 0 && t.setChartScale(t.$chart, 0.8);
            }
        },
        bindZoom: function () {
            this.$chartContainer.on("wheel", { oc: this }, this.zoomWheelHandler),
                this.$chartContainer.on("touchstart", { oc: this }, this.zoomStartHandler),
                v(f).on("touchmove", { oc: this }, this.zoomingHandler),
                v(f).on("touchend", { oc: this }, this.zoomEndHandler);
        },
        unbindZoom: function () {
        ...
        setChartScale: function (e, t) {
            ...
            "none" === n
                ...
                : ((s = n.split(",")),
                  -1 === n.indexOf("3d")
                      ? (a = Math.abs(p.parseFloat(s[3]) * t)) > i.zoomoutLimit && a < i.zoominLimit && e.css("transform", n + " scale(" + t + "," + t + ")")
                      : (a = Math.abs(p.parseFloat(s[1]) * t)) > i.zoomoutLimit && a < i.zoominLimit && e.css("transform", n + " scale3d(" + t + "," + t + ", 1)"));
        },
        ...
        getNodeState: function (e, t) {
            var i = {};
            if ("parent" === (t = t || "self")) {
                if ((i = e.closest(".nodes").siblings(":first")).length) return i.is(".hidden") || (!i.is(".hidden") && i.closest(".nodes").is(".hidden")) ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 };
            } else if ("children" === t) {
                if ((i = e.closest("tr").siblings(":last")).length) return i.is(".hidden") ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 };
            } else if ("siblings" === t) {
                if ((i = e.closest("table").parent().siblings()).length) return i.is(".hidden") || i.parent().is(".hidden") ? { exist: !0, visible: !1 } : { exist: !0, visible: !0 };
            } else if ((i = e).length)
                return (i.closest(".nodes").length && i.closest(".nodes").is(".hidden")) ||
                    (i.closest("table").parent().length && i.closest("table").parent().is(".hidden")) ||
                    (i.parent().is("li") && (i.closest("ul").is(".hidden") || i.closest("verticalNodes").is(".hidden")))
                    ? { exist: !0, visible: !1 }
                    : { exist: !0, visible: !0 };
            return { exist: !1, visible: !1 };
        },
        getRelatedNodes: function (e, t) {
            return e && e instanceof v && e.is(".node")
                ? "parent" === t
                    ? e.closest(".nodes").parent().children(":first").find(".node")
                    : "children" === t
                    ? e.closest("tr").siblings(".nodes").children().find(".node:first")
                    : "siblings" === t
                    ? e.closest("table").parent().siblings().find(".node:first")
                    : v()
                : v();
        },
        ...
        hideChildrenEnd: function (e) {
            ...
            e.data.animatedNodes.removeClass("sliding"),
                e.data.isVerticalDesc
                    ? e.data.lowerLevel.addClass("hidden")
                    : (e.data.animatedNodes.closest(".nodes").prevAll(".lines").removeAttr("style").addBack().addClass("hidden"), e.data.lowerLevel.last().find(".verticalNodes").addClass("hidden")),
                this.isInAction(t) && this.switchVerticalArrow(t.children(".bottomEdge"));
        },
        hideChildren: function (e) {
            ...
            n || i.closest("table").closest("tr").prevAll(".lines").css("visibility", "hidden"),
                this.repaint(i.get(0)),
                i.addClass("sliding slide-up").eq(0).one("transitionend", { animatedNodes: i, lowerLevel: t, isVerticalDesc: n, node: e }, this.hideChildrenEnd.bind(this));
        },
        ...
        hideSiblingsEnd: function (e) {
            ...
            i
                ...
                .prev()
                .children(":not(.hidden)")
                .slice(1, n ? 2 * s.length + 1 : -1)
                .addClass("hidden"),
                e.data.animatedNodes.removeClass("sliding"),
                s.find(".node:gt(0)").filter(this.isVisibleNode.bind(this)).removeClass("slide-left slide-right").addClass("slide-up"),
                s.find(".lines, .nodes, .verticalNodes").addClass("hidden").end().addClass("hidden"),
                this.isInAction(t) && this.switchHorizontalArrow(t);
        },
        hideSiblings: function (e, t) {
            var i = e.closest("table").parent();
            i.siblings().find(".spinner").length && e.closest(".orgchart").data("inAjax", !1),
                t
                    ? "left" === t
                        ? i.prevAll().find(".node").filter(this.isVisibleNode.bind(this)).addClass("sliding slide-right")
                        : i.nextAll().find(".node").filter(this.isVisibleNode.bind(this)).addClass("sliding slide-left")
                    : (i.prevAll().find(".node").filter(this.isVisibleNode.bind(this)).addClass("sliding slide-right"), i.nextAll().find(".node").filter(this.isVisibleNode.bind(this)).addClass("sliding slide-left"));
            ...
            if (
                (t
                    ? n
                          ...
                          .slice(0, 2 * i.length)
                          .removeClass("hidden")
                    : n.eq(2).children(".hidden").removeClass("hidden"),
        ...
        startLoading: function (e) {
            ...
            return (
                ...
                (e.addClass("hidden"),
                e.parent().append('<i class="fa fa-circle-o-notch fa-spin spinner"></i>').children().not(".spinner").css("opacity", 0.2),
                t.data("inAjax", !0),
                v(".oc-export-btn" + ("" !== this.options.chartClass ? "." + this.options.chartClass : "")).prop("disabled", !0),
                !0)
            );
        },
        endLoading: function (e) {
            ...
            e.removeClass("hidden"),
                ...
                v(".oc-export-btn" + ("" !== this.options.chartClass ? "." + this.options.chartClass : "")).prop("disabled", !1);
        },
        ...
        nodeEnterLeaveHandler: function (e) {
            ...
            "mouseenter" === e.type
                ? (n.length && ((i = this.getNodeState(t, "parent").visible), n.toggleClass("fa-chevron-up", !i).toggleClass("fa-chevron-down", i)),
                  s.length && ((i = this.getNodeState(t, "children").visible), s.toggleClass("fa-chevron-down", !i).toggleClass("fa-chevron-up", i)),
                  a.length && this.switchHorizontalArrow(t))
                : t.children(".edge").removeClass("fa-chevron-up fa-chevron-down fa-chevron-right fa-chevron-left");
        },
        ...
        loadNodes: function (t, e, i) {
            var n = this;
            this.options;
            v.ajax({ url: e, dataType: "json" })
                .done(function (e) {
                    n.$chart.data("inAjax") &&
                        ("parent" === t ? v.isEmptyObject(e) || n.addParent(i.parent(), e) : "children" === t ? e.children.length && n.addChildren(i.parent(), e[t]) : n.addSiblings(i.parent(), e.siblings ? e.siblings : e));
                })
                .fail(function () {
        ...
        hEdgeClickHandler: function (e) {
            ...
            if (s.exist) {
                ...
                var d = i[0].id,
                    r = this.getNodeState(i, "parent").exist
                        ? v.isFunction(n.ajaxURL.siblings)
                            ? n.ajaxURL.siblings(i.data("nodeData"))
                            : n.ajaxURL.siblings + d
                        : v.isFunction(n.ajaxURL.families)
                        ? n.ajaxURL.families(i.data("nodeData"))
        ...
        toggleVNodes: function (e) {
            ...
            s.is(".sliding") ||
                (t.toggleClass("fa-plus-square fa-minus-square"),
                n.eq(0).is(".slide-up")
                    ? (i.removeClass("hidden"), this.repaint(s.get(0)), s.addClass("sliding").removeClass("slide-up").eq(0).one("transitionend", { vNodes: s }, this.expandVNodesEnd))
        ...
        createGhostNode: function (e) {
            ...
            f.querySelector(".ghost-node")
                ? ((t = n.closest(".orgchart").children(".ghost-node").get(0)), (i = v(t).children().get(0)))
                : ((t = f.createElementNS("http://www.w3.org/2000/svg", "svg")).classList.add("ghost-node"), (i = f.createElementNS("http://www.w3.org/2000/svg", "rect")), t.appendChild(i), n.closest(".orgchart").append(t));
            ...
            t.setAttribute("width", r ? n.outerWidth(!1) : n.outerHeight(!1)),
                t.setAttribute("height", r ? n.outerHeight(!1) : n.outerWidth(!1)),
                i.setAttribute("x", 5 * l),
                i.setAttribute("y", 5 * l),
                i.setAttribute("width", 120 * l),
                i.setAttribute("height", 40 * l),
                i.setAttribute("rx", 4 * l),
                i.setAttribute("ry", 4 * l),
                i.setAttribute("stroke-width", 1 * l);
            var h = a.offsetX * l,
                c = a.offsetY * l;
            if (
                ("l2r" === s.direction
                    ? ((h = a.offsetY * l), (c = a.offsetX * l))
                    : "r2l" === s.direction
                    ? ((h = n.outerWidth(!1) - a.offsetY * l), (c = a.offsetX * l))
                    : "b2t" === s.direction && ((h = n.outerWidth(!1) - a.offsetX * l), (c = n.outerHeight(!1) - a.offsetY * l)),
                o)
            ) {
        ...
        dropHandler: function (e) {
            ...
            if ((this.$chart.trigger(s, { draggedNode: i, dragZone: n.children(), dropZone: t }), !s.isDefaultPrevented())) {
                if (t.closest("tr").siblings().length) {
                    ...
                    t.closest("tr").next().addBack().children().attr("colspan", a),
                        i.find(".horizontalEdge").length || i.append(o),
                        t.closest("tr").siblings().eq(1).children(":last").before('<td class="leftLine topLine"></td><td class="rightLine topLine"></td>').end().next().append(i.closest("table").parent());
                    var d = i.closest("table").parent().siblings().find(".node:first");
                    1 === d.length && d.append(o);
                } else
                    t.append('<i class="edge verticalEdge bottomEdge fa"></i>')
                        .parent()
                        .attr("colspan", 2)
                        .parent()
                        .after('<tr class="lines"><td colspan="2"><div class="downLine"></div></td></tr><tr class="lines"><td class="rightLine"></td><td class="leftLine"></td></tr><tr class="nodes"></tr>')
                        .siblings(":last")
                        .append(i.find(".horizontalEdge").remove().end().closest("table").parent());
        ...
        touchstartHandler: function (e) {
            console.log("orgChart: touchstart 1: touchHandled=" + this.touchHandled + ", touchMoved=" + this.touchMoved + ", target=" + e.target.innerText),
                this.touchHandled || ((this.touchHandled = !0), (this.touchMoved = !1), e.preventDefault());
        },
        touchmoveHandler: function (e) {
            if (this.touchHandled) {
                ...
                if (0 < t.length) {
                    var i = t[0];
                    t.is(".allowedDrop")
                        ? (console.log("orgChart: touchmove 2: this node (" + i.id + ") is allowed to be a drop target"), (this.touchTargetNode = i))
                        : (console.log("orgChart: touchmove 3: this node (" + i.id + ") is NOT allowed to be a drop target"), (this.touchTargetNode = null));
        ...
        createNode: function (i) {
            var e = this.options,
                t = i.level;
            i.children &&
                v.each(i.children, function (e, t) {
                    t.parentId = i.id;
                });
            var n = v("<div" + (e.draggable ? ' draggable="true"' : "") + (i[e.nodeId] ? ' id="' + i[e.nodeId] + '"' : "") + (i.parentId ? ' data-parent="' + i.parentId + '"' : "") + ">").addClass(
                "node " + (i.className || "") + (t > e.visibleLevel ? " slide-up" : "")
            );
            var bgColor = 'style="background-color:rgb(70,121,167)  !important;"';
            /*if(i[e.nodeContent] == 'senior engineer')
            {
							bgColor = 'style="background-color:blue !important;"';
            }
            else if(i[e.nodeContent] == 'engineer')
            {
							bgColor = 'style="background-color:green !important;"';
            }
            else if(i[e.nodeContent] == 'department manager')
            {
							bgColor = 'style="background-color:#fea701 !important;"';
            }*/
            e.nodeTemplate ? n.append(e.nodeTemplate(i)) : n.append('<div style="float:left;width: 40%;"><img src="assets/media/users/blank.png" style="width:90px;height:auto;left:4px;position: absolute;"></div>').append('<div style="float:right;width: 60%;"><div class="title" '+bgColor+'>' + i[e.nodeTitle] + "</div>").append(void 0 !== e.nodeContent ? '<div style="float:right;width: 60%;"><div class="content" style="border-bottom:0px !important;">' + (i[e.nodeContent] || "") + "</div>" : "").append(void 0 !== e.nodeMail ? '<div style="float:right;width: 60%;"><div class="content" style="border-top:0px !important;">' + (i[e.nodeMail] || "") + "</div>" : "");
            var s = v.extend({}, i);
            ...
            if (e.verticalLevel && t >= e.verticalLevel) {
                ...
                Number(a.substr(0, 1)) && n.append('<i class="edge verticalEdge topEdge fa"></i>'),
                    Number(a.substr(1, 1)) && n.append('<i class="edge horizontalEdge rightEdge fa"></i><i class="edge horizontalEdge leftEdge fa"></i>'),
                    Number(a.substr(2, 1)) &&
                        n
                            .append('<i class="edge verticalEdge bottomEdge fa"></i>')
                            .children(".title")
                            .prepend('<i class="fa ' + e.parentNodeSymbol + ' symbol"></i>');
            return (
                n.on("mouseenter mouseleave", this.nodeEnterLeaveHandler.bind(this)),
                n.on("click", this.nodeClickHandler.bind(this)),
                n.on("click", ".topEdge", this.topEdgeClickHandler.bind(this)),
                n.on("click", ".bottomEdge", this.bottomEdgeClickHandler.bind(this)),
                n.on("click", ".leftEdge, .rightEdge", this.hEdgeClickHandler.bind(this)),
                n.on("click", ".toggleBtn", this.toggleVNodes.bind(this)),
                e.draggable && (this.bindDragDrop(n), (this.touchHandled = !1), (this.touchMoved = !1), (this.touchTargetNode = null)),
                e.createNode && e.createNode(n, i),
                n
            );
        },
        buildHierarchy: function (e, t) {
            ...
            if (d) {
                ...
                if (c)
                    (l = v("<ul>")),
                        h && s + 1 > n.verticalLevel && l.addClass(h),
                        s + 1 === n.verticalLevel
                            ? e
                                  .children("table")
                                  .append('<tr class="verticalNodes' + h + '"><td></td></tr>')
                                  .find(".verticalNodes")
                                  .children()
                                  .append(l)
                            : e.append(l);
                else {
                    for (var g = v('<tr class="lines' + h + '"><td colspan="' + 2 * o.length + '"><div class="downLine"></div></td></tr>'), p = '<tr class="lines' + h + '"><td class="rightLine"></td>', f = 1; f < o.length; f++)
        ...
        buildChildNode: function (e, t) {
            e.find("td:first").attr("colspan", 2 * t.length), this.buildHierarchy(e, { children: t });
        },
        addChildren: function (e, t) {
            this.buildChildNode(e.closest("table"), t),
                e.children(".bottomEdge").length || e.append('<i class="edge verticalEdge bottomEdge fa"></i>'),
                e.find(".symbol").length || e.children(".title").prepend('<i class="fa ' + this.options.parentNodeSymbol + ' symbol"></i>'),
                this.isInAction(e) && this.switchVerticalArrow(e.children(".bottomEdge"));
        },
        buildParentNode: function (e, t) {
            t.relationship = t.relationship || "001";
            var i = v("<table>")
                .append(v("<tr>").append(v('<td colspan="2">').append(this.createNode(t))))
        ...
        addSiblings: function (e, t) {
            this.buildSiblingNode(e.closest("table"), t),
                e.closest(".nodes").data("siblingsLoaded", !0),
                e.children(".leftEdge").length || e.children(".topEdge").after('<i class="edge horizontalEdge rightEdge fa"></i><i class="edge horizontalEdge leftEdge fa"></i>'),
                this.isInAction(e) && (this.switchHorizontalArrow(e), e.children(".topEdge").removeClass("fa-chevron-up").addClass("fa-chevron-down"));
        },
        removeNodes: function (e) {
            ...
            t.is("td")
                ? this.getNodeState(e, "siblings").exist
                    ? (i.eq(2).children(".topLine:lt(2)").remove(), i.slice(0, 2).children().attr("colspan", i.eq(2).children().length), t.remove())
                    : i.eq(0).children().removeAttr("colspan").find(".bottomEdge").remove().end().end().siblings().remove()
                : t.add(t.siblings()).remove();
        },
        export: function (r, l) {
            var h = this;
            ...
            html2canvas(t, {
                ...
                onrendered: function (e) {
                    if ((c.find(".mask").addClass("hidden"), "pdf" === l.toLowerCase())) {
                        var t = {},
                            i = Math.floor(0.2646 * e.width),
                            n = Math.floor(0.2646 * e.height);
